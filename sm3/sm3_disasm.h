...
public:
  ...
  void disassembleOp(std::ostream& stream, const Instruction& op, const ShaderInfo& info);

  /** Disassemble instruction into a string. */
  std::string disassembleOp(const Instruction& op, const ShaderInfo& info);
...
private:
  ...
  void disassembleRegisterType(std::ostream& stream, RegisterType registerType, const ShaderInfo& info) const;

  void disassembleRegisterAddressing(std::ostream& stream, const Instruction& op, const Operand& arg, const ShaderInfo& info) const;
